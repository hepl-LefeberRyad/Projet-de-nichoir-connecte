# MQTT
## Introduction 
Dans cette partie du répertoire, nous documentons notre progrès dans l’implémentation du protocole MQTT pour notre projet. Un dossier contient notre progrés avec le code en Arduino l'autre avec notre progrés en RP.
